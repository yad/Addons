...
addon.config = {
	...
	mainbars = {
		scale_actionbar = 1,			--; mainbar scale.
		scale_rightbar = 1,			--; multibar right scale (under minimap).
		scale_leftbar = 1,			--; multibar left scale (under minimap).
	...
	-- @param: old, new, [flying - only for gryphons], [none - for hide]
		gryphons = 'hide',	--; display style for gryphons.
