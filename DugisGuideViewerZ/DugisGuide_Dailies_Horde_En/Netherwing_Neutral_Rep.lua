DugisGuideViewer:RegisterGuide("Outlands - Netherwing (Neutral Reputation)", nil, "Horde", "D", function()
return [[

F Shadowmoon Valley |N|Fly to shadowmoon Valley and head to Mordenai (60.0, 58.5)|  |Z|Shadowmoon Valley|
