DugisGuideViewer:RegisterGuide("Speed Gold Run - AT Rank:Aspirant (80 Dailies)", nil, "Horde", "D", function()
return [[

F K3 |N|Fly to K3 in The Storm Peaks|
...
F Dun Niffelem |N|Fly to Dun Niffelem (64, 61)| |Z|The Storm Peaks|
...
F Crusaders' Pinnacle |N|Fly to Crusaders' Pinnacle, use Morlia Doomwing (43.7, 24.4)| |Z|Icecrown|
