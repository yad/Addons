...
local config = {
	...
	-- general settings:
	global = {
		classportraits = false, -- enable portraits by class
	...
	player = {
		...
		elite = false, -- make yourself an elite
		level = true, -- show player level
		leadericon = true, -- show player leader icon
		name = true, -- show player name
		petname = true, -- show pet name
	...
	target = {
		...
		level = true, -- show target level
		leadericon = true, -- show target leader icon
	...
	focus = {
		scale = 1, -- focus scale
		level = true, -- show focus level
		leadericon = true, -- leader icon
